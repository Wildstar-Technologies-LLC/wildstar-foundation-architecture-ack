...
implements CreditCard {
   private static int sampleExpirationMonth=0;
   private static int sampleExpirationYear=0;
   static {
      Calendar calendar = null;
      calendar = new GregorianCalendar();
      calendar.add(Calendar.YEAR, 3);
      MockCreditCard.sampleExpirationMonth = calendar.get(Calendar.MONTH) + 1;
      MockCreditCard.sampleExpirationYear = calendar.get(Calendar.YEAR);
   }
   ...
   public static int getSampleExpirationMonth() {
      return MockCreditCard.sampleExpirationMonth;
   }
   
   public static int getSampleExpirationYear() {
      return MockCreditCard.sampleExpirationYear;
   }
