...
public class TestCaseAustralianBankCard8250 extends MockCreditCard {
   public TestCaseAustralianBankCard8250() {
      super("Australian Bank Card (8250)",
         "5610591081018250",
         "Australian Bank Card",
         "Johnny Appleseed",
         "ACME Bank",
         "2121" ,
         getSampleExpirationMonth(),
         getSampleExpirationYear()
      );
   }
}